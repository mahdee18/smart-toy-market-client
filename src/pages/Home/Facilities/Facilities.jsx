    ...
    return (
        <div className='my-16 px-6 md:px-14'>
            <div data-aos="zoom-in" className='text-center mb-6'>
                <h2 className="text-3xl font-extrabold text-gray-900 mb-4">Our Facilities</h2>
                <p className="text-lg text-gray-600">We enhance your child's joy with top-tier playthings!</p>
            </div>
            <div className='grid md:grid-cols-4 gap-4'>
                ...
                <div data-aos="zoom-in" className='text-center p-10 rounded shadow-xl space-y-3'>
                    <img className='mx-auto' src='https://th.bing.com/th/id/OIP.liNbEXd5vYq05eSVWfGqpwHaHa?rs=1&pid=ImgDetMain' alt="" />
