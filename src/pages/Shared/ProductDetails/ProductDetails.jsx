...
const ProductDetails = () => {
    ...
    const { category, picture, name, price, rating, quantity, seller, description } = toy
    return (
        <div className=" mt-10 mx-auto bg-white rounded-lg shadow-md overflow-hidden w-full grid md:grid-cols-2 gap-0 justify-items-center items-center">
            ...
            <div className="px-4 py-2 w-1/2">
                ...
                <div className="text-gray-500 text-lg mt-2">
                    ...
                    <button className="bg-[#ff6e13] btn border-0  text-white px-4 py-2 rounded-md mt-4 w-full flex items-center justify-center font-bold gap-5">
